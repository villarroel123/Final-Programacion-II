...
export class Product {
    ...
    constructor(data) {
        ...
        __classPrivateFieldSet(this, _Product_id, data.id, "f");
        __classPrivateFieldSet(this, _Product_name, data.name, "f");
        __classPrivateFieldSet(this, _Product_price, data.price, "f");
        __classPrivateFieldSet(this, _Product_category, data.category, "f");
        __classPrivateFieldSet(this, _Product_image, data.image, "f");
        __classPrivateFieldSet(this, _Product_description, data.description, "f");
    }
    //Getters
    getId() {
